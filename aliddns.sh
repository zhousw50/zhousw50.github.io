aliddnsipv6_ak="LTAI5tJ4PqStXcMtRjxd1aX8"  #换成你阿里去AccessKdy的ID
aliddnsipv6_sk="0BWrjphSXTDveCWE2czM3Bb4tSjRNZ"  #换成你阿里云AccessKey的密码
aliddnsipv6_name1='nas'  #换成你的二级域名（随便填，自已记住就行）
aliddnsipv6_domain='zhousw.top'  #换成你在阿里云注册的域名
aliddnsipv6_ttl="600"
...
ipv6s=`ip addr show wlan1 | grep "inet6.*global" | awk '{print $2}' | awk -F"/" '{print $1}'` || die "$ipv6"
